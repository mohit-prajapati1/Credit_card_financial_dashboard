...
COPY cc_detail
FROM 'C:\Credit Card Project\Data\credit_card.csv' 
DELIMITER ',' 
CSV HEADER;
...
SET datestyle = 'ISO, DMY';
COPY cust_detail
FROM 'C:\Credit Card Project\Data\customer.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'C:\Credit Card Project\Data\cc_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Credit Card Project\Data\cust_add.csv' 
DELIMITER ',' 
CSV HEADER;
